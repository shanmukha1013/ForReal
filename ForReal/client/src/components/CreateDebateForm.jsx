      ...
      <div className="p-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
          <input
            ...
            className="bg-black/60 border border-white/10 rounded-xl px-4 py-3 text-brand placeholder-gray-500 focus:outline-none focus:border-brand/50 transition text-sm"
          />
          <select
            value={debateMode}
            onChange={(e) => setDebateMode(e.target.value)}
            className="bg-black/60 border border-white/10 rounded-xl px-4 py-3 text-brand focus:outline-none focus:border-brand/50 text-sm"
          >
        ...
        {debateMode !== 'Open Discussion' && (
          <div className="mb-4 p-4 border border-white/10 rounded-xl bg-white/5">
              ...
              {customOptions.map((opt, idx) => (
                <div key={idx} className="flex gap-2 items-center">
                  <input
                    ...
                    className="flex-1 bg-black/60 border border-white/10 rounded-xl px-4 py-2 text-brand placeholder-gray-500 focus:outline-none focus:border-brand/50 text-sm"
                  />
            ...
            <button onClick={handleAddOption} className="mt-3 flex items-center gap-1 text-xs text-brand hover:text-green-300">
        ...
        <div className="flex justify-end mt-4">
          <motion.button
            ...
            className="flex items-center gap-2 px-6 py-2.5 rounded-xl bg-brand text-brand font-bold text-sm disabled:opacity-50 transition shadow-lg shadow-brand/20"
          >
